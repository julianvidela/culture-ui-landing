...
//            className="lg:hidden fixed inset-x-0 bottom-0 h-[70vh] w-auto bg-black z-50 rounded-t-2xl shadow-2xl  overflow-y-auto">
      ...
      <AnimatePresence>
        {isMenuOpen && (
          <>
            ...
            >
              <div
                className="bg-[#0a0a0a] h-[75vh] overflow-y-auto scroll-smooth scrollbar-hidden  border-[var(--border-primary)]  border rounded-t-2xl bottom-0 p-4 shadow-xl  mx-auto w-full flex flex-col gap-4"
